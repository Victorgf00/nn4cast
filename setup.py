...
setuptools.setup(
    ...
    install_requires=[
        'numpy==1.26.4', 'matplotlib==3.8.4', 'xarray==2024.3.0', 'pandas==1.5.3', 'xskillscore==0.0.26', 'scipy==1.10.1', 'tensorflow==2.7.0', 'keras==2.7.0', 'keras-tuner==1.0.2', 'scikit-learn==1.0.2', 'alibi==0.7.0', 'netcdf4'==1.6.2
 ],
